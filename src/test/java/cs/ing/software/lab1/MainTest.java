...
public class MainTest {
    ...
    @Test()
    public void test21() {
        Vehicle toyota = new Vehicle(10, tanqueCapacidad);
        Assert.assertEquals(toyota.trip((float) 3.0), "3.0");
    }

    @Test()
    public void test22() {
        Vehicle toyota = new Vehicle(10, tanqueCapacidad);
        Assert.assertEquals(toyota.supplying((float) 3.0), "3.0");
    }
    ...
    public void test24() {
        Truck volvo = new Truck(10, tanqueCapacidad);
        Assert.assertEquals(volvo.supplying(40), "La cantidad de combustible del Camion es: 48.000000");
    }
}
